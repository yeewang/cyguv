...
cyguv-$(Version).dll libuv-$(Version).dll.a uv.pc: cyguv.c uv.pc.in
	$(CC) $(Debug) -shared -o cyguv-$(Version).dll -Wl,--out-implib=libuv-$(Version).dll.a -I../libuv-v1.9.1/include cyguv.c
...
cyguv-test.exe: cyguv-test.c cyguv-$(Version).dll libuv-$(Version).dll.a
	$(CC) $(Debug) -o cyguv-test.exe -I$(PWD)/libuv/include -Dcyguv cyguv-test.c -L$(PWD) -luv-$(Version)
...
clean:
	rm cyguv-$(Version).dll libuv-$(Version).dll.a cyguv-test.exe
